...
export const STATUS_COLORS = {
    ...
    'Hold': '#64748b', // slate
    'Waiting for payment': '#ca8a04', // dark yellow
    'Waiting of payment': '#ca8a04', // legacy alias (typo) kept for old data
...
export const PROJECT_COLUMN_CATALOG = [
    ...
    { field: 'custom_engagement_date', label: 'Engagement Date', width: 150 },
    ...
    { field: 'custom_grants_salesperson', label: 'Salesperson', width: 150 },
