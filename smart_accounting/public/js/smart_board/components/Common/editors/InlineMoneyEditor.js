/**
 * InlineMoneyEditor
 * - Simple numeric input; formatting/validation handled by column spec.
 */
export class InlineMoneyEditor {
  ...
  render() {
    ...
    this.mountEl.innerHTML = `
      <input class="form-control sb-inline-editor sb-inline-editor--money" type="number" step="0.01" />
    `;
    this._input = this.mountEl.querySelector('input.sb-inline-editor--money');
    if (this._input) {
